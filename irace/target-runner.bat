...
::
::C:\Users\sam24\.conda\envs\machine_learning\python.exe %exe% %fixed_params% -i %instance% --seed %seed% %candidate_parameters%
::exit 0
:: 
:: Otherwise, save the output to a file, and parse the result from it.

:: C:\Users\sam24\.conda\envs\machine_learning\python.exe %exe% %candidate_parameters% --datfile %DAT_FILE% > %LOGS% 2>&1
 C:\Users\sam24\.conda\envs\machine_learning\python.exe %exe% %candidate_parameters% --datfile %DAT_FILE% >NUL
